...
+ (void)doRegister:(UIImage *)image reslut:(void(^)(int error,AFR_FSDK_PERSON person))complete {
    ...
    AFR_FSDK_PERSON JOHNVISIONERRORNULL = {0};
    ...
    if( result_FD != MOK ){complete(JOHNVISIONERROR_01,JOHNVISIONERRORNULL); return;}
    ...
    if( result_FR != MOK ){complete(JOHNVISIONERROR_02,JOHNVISIONERRORNULL);return;}
    ...
    if( result_FD_FACE != MOK ){complete(JOHNVISIONERROR_03,JOHNVISIONERRORNULL);return;}
//
    if( pFaceResFD->nFace == 0 ){complete(JOHNVISIONERROR_04,JOHNVISIONERRORNULL);return;}
    if( pFaceResFD->nFace  > 1 ){complete(JOHNVISIONERROR_05,JOHNVISIONERRORNULL);return;}
    ...
    if( result_FD_Feature != MOK ){complete(JOHNVISIONERROR_06,JOHNVISIONERRORNULL);return;}
    ...
    if( mr_Uninit_FD != MOK ){complete(JOHNVISIONERROR_07,JOHNVISIONERRORNULL);return;}
    ...
    if( mr_Uninit_FR != MOK ){complete(JOHNVISIONERROR_08,JOHNVISIONERRORNULL);return;}
